...
<div class="animated slideInLeft auth_v2">
    <div class="auth_v2_box" style="max-width: 600px !important">
        <div class="text-center">
           <h1 class="h4 text-gray-900 mb-4" style="padding-top: 30px">Lupa Password</h1>
        </div>
         <?= $this->session->flashdata('message'); ?>
        <form action="<?php echo base_url() ?>Akun/LupaPassword" method="POST">
            
            <div class="form-group">
              
                <input class="form-control" placeholder="Email Address" type="text" name="username" value="<?= set_value('username'); ?>"><?= form_error('username', '<small class="text-danger pl-3">', '</small>'); ?>
               <!--  <div class="pre-icon material-icons">account_circle</div> -->
            </div>
          
            <div class="buttons-w">
                <input type="hidden" name="login">
                <button style="width: 100%" class="btn btn-wd btn-purple" type="submit">Reset Password</button>
            </div>
