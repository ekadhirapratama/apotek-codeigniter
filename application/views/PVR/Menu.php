            ...
            <div class="user">
                ...
                <div class="info">
                    <a data-toggle="collapse" href="#pvr_user_nav" class="collapsed">
                            <span><?php echo $this->session->nama; ?>
                                <b class="caret"></b>
                            </span>
                    </a>
            ...
            <ul class="nav">
                 ...
                 <li class="nav-item has-sub-menu">
                    ...
                    <div class="collapse sub-menu" id="pvr_applications">
                        ...
                        foreach (range('A', 'Z') as $char) { ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link sub_link" href="<?php echo base_url(); ?>MasterData/Pasien/<?=$char?>" >
                                    <i class="material-icons">keyboard_arrow_right</i>
                                    <span class="sidebar-normal">Pasien <?=$char?></span>
                                </a>
                            </li>
                ...
                <li class="nav-item has-sub-menu">
                    ...
                    <div class="collapse sub-menu" id="pvr_applications">
                        <ul class="nav">
                            <li class="nav-item">
                                <a class="nav-link sub_link" href="<?php echo base_url(); ?>MasterData/Satuan">
                                    <i class="material-icons">keyboard_arrow_right</i>
                                    <span class="sidebar-normal">Satuan</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link sub_link" href="<?php echo base_url(); ?>MasterData/Obat">
                                    <i class="material-icons">keyboard_arrow_right</i>
                                    <span class="sidebar-normal">Obat</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link sub_link" href="<?php echo base_url(); ?>MasterData/Stok">
                                    <i class="material-icons">keyboard_arrow_right</i>
                ...
                <!--    <li class="nav-item">-->
                <!--    <a class="nav-link" href="<?php echo base_url(); ?>MasterData/Satuan">-->
                <!--        <i class="material-icons">list</i>-->
                <!--       <p>Satuan</p>-->
                <!--    </a>-->
                <!--</li> -->
                <!-- <li class="nav-item">-->
                <!--    <a class="nav-link" href="<?php echo base_url(); ?>MasterData/Obat">-->
                <!--        <i class="material-icons">list</i>-->
                <!--       <p>Obat</p>-->
                <!--    </a>-->
                <!--</li>-->
