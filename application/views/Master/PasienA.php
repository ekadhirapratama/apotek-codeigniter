        ...
        <div class="col-lg-12">
            <div class="pvr-wrapper">
                <div class="pvr-box">
                    ...
                    <a href="javascript:TambahData()" class="btn btn-wd btn-primary">TAMBAH</a>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="padding: 0 20px">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Pasien A</h5>
            ...
            <form id="TambahData" action="" method="post">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label>NIK:</label>
                 <input type="text" class="form-control" name="nik" id="hanyaAngka" onkeydown="CekInput()">
              </div>
              <div class="form-group">
                <label>Alamat:</label>
              ...
              <div class="modal-footer">
                <input type="hidden" class="form-control" name="status" value="Pasien A">  
...
<div class="modal fade" id="ModalEdit">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="padding: 0 20px">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Pasien A</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    $(function() {
        ...
        var dataTable = $('#datatable').DataTable( {
          ...
          $( row ).find('td:eq(3)').attr('align', 'center');
            ...
            "ajax":{
                url :"<?php echo base_url(); ?>MasterData/PasienAJson", 
                type: "post",
                error: function(){
      ...
      $.post({
        ...
        success: function (success) {
          if (success) {
            ...
            $('form#TambahData #nomor').text(data.nomor);
