    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="padding: 0 20px">
            ...
            <!--   <div class="form-group">
                ...
                <div class="form-group">
                <label>Stok:</label>
                 <input type="text" class="form-control" name="qty" id="hanyaAngka" onkeydown="CekInput()">
              </div>
           -->
...
<script type="text/javascript" language="javascript" >
    ...
    $(function() {
        ...
        var dataTable = $('#datatable').DataTable( {
          ...
          $( row ).find('td:eq(2)').attr('align', 'center');
            ...
            "ajax":{
                url :"<?php echo base_url(); ?>MasterData/SatuanJson", 
                type: "post",
                error: function(){
    ...
    $("form#TambahData").submit(function(event){
      ...
      $.post({
        url :"<?php echo base_url(); ?>MasterData/TambahSatuan",
        data: formData,
        async: false,
        cache: false,
        contentType: false,
    ...
    function Edit(idx) {
      $.post({
        url :"<?php echo base_url(); ?>MasterData/EditSatuan",
        data: {id:idx},
        success: function (success) {
          if (success) {
